...
test('it posts a marked summary, eligible inlines, and a kappy-review check run', function () {
    ...
    expect($review->summary_comment_id)->toBe(10)
        ...
        ->and($scm->postCommentCalls[0]['installationId'])->toBe(42)
        ->and($scm->postCommentCalls[0]['repositoryFullName'])->toBe('acme/widgets')
        ->and($scm->postCommentCalls[0]['pullRequestNumber'])->toBe(5)
