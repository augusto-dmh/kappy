...
> **Module structure reference:** For Kappy's modular-monolith layout, module conventions, and boundary rules, see `app-modules/README.md` and `.specs/adr/0001-module-boundary-rules-and-architecture-fitness-functions.md`.
