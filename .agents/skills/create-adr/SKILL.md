...
1. Check if an ADR directory exists (in Kappy the convention is `.specs/adr/`; also accept `docs/adr/`, `docs/decisions/`, `.adr/`, or `adr/`)
...
Suggested file path: .specs/adr/{NNN}-{kebab-case-title}.md

Would you like me to:
1. Save it to .specs/adr/ (Kappy's convention)
...
- Kebab-case title
- `.md` extension
- Kappy's directory: `.specs/adr/` (sits beside `.specs/project/STATE.md`, where pre-ADR decisions were logged). Other common directories elsewhere: `docs/adr/`, `docs/decisions/`, `adr/`, `.adr/`
